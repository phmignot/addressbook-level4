...
In the debtors panel, any persons who owe the selected person will appear with
the amount that they owe.
In the creditors panel, any persons who are owed by the selected person will
...
* *AddTransaction* `deleteTransaction INDEX` +
e.g. `addTransaction r/John Doe a/3456.00 d/for dinner meal e/Tom Riddle e/Becky Simmons`
* *Clear* : `clear`
* *Undo* : `undo`
* *Redo* : `redo`
