...
Major Feature: Allow User to specify the type of expense spent on
               - allow the user to keep track of his/her spending for better planning in the trip
Minor Feature: Allow User to edit the an added transaction
               - so the user can amend the transaction in the even any error such as the wrong amount was added
