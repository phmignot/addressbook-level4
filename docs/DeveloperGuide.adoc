...
From the diagram above, when users enter the command addTransaction /r Payer /a Amount /d Description /e Payee to add a new a Transaction in their address book, AddTransactionCommandParser will parse the arguments, and return AddTransactionCommand.
