...
- Allow user to delete their transactions.
- Implement a table that collects the debts between every person, called DebtsTable.
****

* *Code contributed*: [https://github.com/CS2103JAN2018-W10-B1/main/blob/master/collated/functional/phmignot.md[Functional code]] 
[https://github.com/CS2103JAN2018-W10-B1/main/blob/master/collated/test/phmignot.md[Test code]] _{give links to collated code files}_
