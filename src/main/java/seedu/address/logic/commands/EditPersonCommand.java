...
import static seedu.address.model.Model.PREDICATE_SHOW_NO_TRANSACTION;
...
/**
 * Edits the details of an existing person in the smartsplit application.
 */
public class EditPersonCommand extends UndoableCommand {
    ...
    public CommandResult executeUndoableCommand() throws CommandException {
        ...
        model.updateFilteredTransactionList(PREDICATE_SHOW_NO_TRANSACTION);
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        Balance unchangedBalance = personToEdit.getBalance();
        Set<Tag> updatedTags = editPersonDescriptor.getTags().orElse(personToEdit.getTags());

        return new Person(updatedName, updatedPhone, updatedEmail, unchangedBalance, updatedTags);
    }
