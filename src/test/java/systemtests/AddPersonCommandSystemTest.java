...
import static seedu.address.logic.commands.CommandTestUtil.NAME_DESC_JACK;
...
public class AddPersonCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_JACK).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        command = AddPersonCommand.COMMAND_WORD + NAME_DESC_JACK + PHONE_DESC_AMY + EMAIL_DESC_AMY + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
